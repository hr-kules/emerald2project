...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARIZARD_MEGA_X] =
    {
        ...
        .natDexNum = NATIONAL_DEX_CHARIZARD_MEGAX,
        .categoryName = _("Flame"),
        .height = 17,
        .weight = 1105,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        .natDexNum = NATIONAL_DEX_CHARIZARD_MEGAY,
        .categoryName = _("Flame"),
        .height = 17,
        .weight = 1005,
        .description = COMPOUND_STRING(
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
	...
	.evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_ALAKAZAM}),
    },
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
	...
	.evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_MACHAMP}),
    },
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_GRAVELER_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sGravelerFormSpeciesIdTable,
	.evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_GOLEM_ALOLA}),
    },
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
	...
	.evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_GENGAR}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_TAUROS_PALDEA_BLAZE] =
    {
        ...
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS_PALDEAF,
        .categoryName = _("Wild Bull"),
        .height = 14,
        .weight = 850,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TAUROS_PALDEA_AQUA] =
    {
        ...
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS_PALDEAW,
        .categoryName = _("Wild Bull"),
        .height = 14,
        .weight = 1100,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEWTWO_MEGA_X] =
    {
        ...
        .natDexNum = NATIONAL_DEX_MEWTWO_MEGAX,
        .categoryName = _("Genetic"),
        .height = 23,
        .weight = 1270,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEWTWO_MEGA_Y] =
    {
        ...
        .natDexNum = NATIONAL_DEX_MEWTWO_MEGAY,
        .categoryName = _("Genetic"),
        .height = 15,
        .weight = 330,
        .description = COMPOUND_STRING(
