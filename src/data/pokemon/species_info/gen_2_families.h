...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FERALIGATR_MEGA] =
    {
      /* +40 Ang, +30 speed, +10 Vert, +20 HP */
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Feraligatr"),
        .cryId = CRY_FERALIGATR,
        .natDexNum = NATIONAL_DEX_FERALIGATR_MEGA,
        .categoryName = _("Big Jaw"),
        .height = 25,
        .weight = 988,
        .description = COMPOUND_STRING(
            "It lurks in shallow water watining for\n"
            "prey. With sharp teeth and strong muscles\n"
            "it overwhelms its prey and enemies with\n"
            "sheer force."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .weight = 625,
        .description = COMPOUND_STRING(
            "A huge influx of energy builds up,\n"
            "when Heracross mega evolves. Its will to\n"
            "fight and endurance are also amplified,\n"
            "causing it to shatter any boundaries."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "are burning hot from high internal\n"
            "temperatures. They are Houndooms \n"
	    "best weapons."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "this Pokémon's true form is revealed. Its\n"
            "territiorial instincts are the only thing\n"
            "keeping it moving."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
