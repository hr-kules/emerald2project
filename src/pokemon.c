...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
  ...
  HOENN_TO_NATIONAL(CHARIZARD_MEGAX),
  HOENN_TO_NATIONAL(CHARIZARD_MEGAY),
  ...
  HOENN_TO_NATIONAL(GROWLITHE_HISUI),
  HOENN_TO_NATIONAL(ARCANINE_HISUI),
  ...
  HOENN_TO_NATIONAL(SANDSHREW_ALOLA),
  HOENN_TO_NATIONAL(SANDSLASH_ALOLA),
  ...
  HOENN_TO_NATIONAL(VULPIX_ALOLA),
  HOENN_TO_NATIONAL(NINETALES_ALOLA),
  ...
  HOENN_TO_NATIONAL(EXEGGUTOR_ALOLA),
  ...
  HOENN_TO_NATIONAL(TAUROS_PALDEA),
  HOENN_TO_NATIONAL(TAUROS_PALDEAF),
  HOENN_TO_NATIONAL(TAUROS_PALDEAW),
  ...
  HOENN_TO_NATIONAL(MEWTWO_MEGAX),
  HOENN_TO_NATIONAL(MEWTWO_MEGAY),
  ...
  HOENN_TO_NATIONAL(BASCULIN_HISUI),
...
const u8 *GetSpeciesPokedexDescription(u16 species)
{
    ...
    if (gSpeciesInfo[species].isMegaEvolution == TRUE)
...
u16 NationalPokedexNumToSpecies(u16 nationalNum)
{
    ...
    /* Mega Entwicklungen abfragen */
    if (gSpeciesInfo[species].isMegaEvolution == TRUE && gSpeciesInfo[species].natDexNum != NATIONAL_DEX_CHARIZARD_MEGAY && gSpeciesInfo[species].natDexNum != NATIONAL_DEX_MEWTWO_MEGAY)
	return GetFormSpeciesId(species, 1);

    if (gSpeciesInfo[species].natDexNum == NATIONAL_DEX_CHARIZARD_MEGAY || gSpeciesInfo[species].natDexNum == NATIONAL_DEX_MEWTWO_MEGAY)
        return GetFormSpeciesId(species, 2);
    

    /* Protomorphose abfragen */
    if (gSpeciesInfo[species].isPrimalReversion == TRUE)
      return GetFormSpeciesId(species, 1);

    /* Alola Formen abfragen */
    if (gSpeciesInfo[species].isAlolanForm == TRUE)
      return GetFormSpeciesId(species, 1);    
    
    /* Galar Formen abfragen */
    if (gSpeciesInfo[species].isGalarianForm == TRUE)
      return GetFormSpeciesId(species, 1);

    /* Hisui Formen abfragen */
    if (gSpeciesInfo[species].isHisuianForm == TRUE && gSpeciesInfo[species].natDexNum != NATIONAL_DEX_BASCULIN_HISUI)
      return GetFormSpeciesId(species, 1);

    /* Hisui Formen abfragen */
    if (gSpeciesInfo[species].natDexNum == NATIONAL_DEX_BASCULIN_HISUI)
      return GetFormSpeciesId(species, 2);

    
    /* Paldea Formen abfragen */
    if (gSpeciesInfo[species].isPaldeanForm == TRUE && gSpeciesInfo[species].natDexNum != NATIONAL_DEX_TAUROS_PALDEAF && gSpeciesInfo[species].natDexNum != NATIONAL_DEX_TAUROS_PALDEAW)
      return GetFormSpeciesId(species, 1);

    /* Zusätzliche Abfragen für weitere formen von Tauros */
    if (gSpeciesInfo[species].natDexNum == NATIONAL_DEX_TAUROS_PALDEAF)
      return GetFormSpeciesId(species, 2);
    
    if (gSpeciesInfo[species].natDexNum == NATIONAL_DEX_TAUROS_PALDEAW)
      return GetFormSpeciesId(species, 3);
